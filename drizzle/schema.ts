...
export const institutions = mysqlTable("institutions", {
  ...
  relationshipType: mysqlEnum("relationshipType", relationshipTypes).default("listed_institution").notNull(),
...
export const applicationDocuments = mysqlTable("applicationDocuments", {
  ...
  validationStatus: mysqlEnum("validationStatus", validationStatuses).default("pending").notNull(),
...
export const actionTokens = mysqlTable("actionTokens", {
  ...
  actionType: varchar("actionType", { length: 64 }).notNull(), // 'user_approval', 'user_rejection', etc.
