...
function LoadingScreen() {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-[#07131f] text-white">
      {fallbackCopy[locale]?.loading || "Chargement..."}
    </div>
  );
}
  ...
  return (
    <Suspense fallback={<LoadingScreen />}>
      <Switch>
        ...
        <Route path="/expertise-internationale" component={ExpertiseInternationale} />
        <Route path="/consulting" component={Consulting} />
        <Route path="/partnerships-strategiques" component={StrategicPartnerships} />
        <Route path="/affiliations" component={Affiliations} />
        <Route path="/study" component={Study} />
        <Route path="/study/contact" component={ServiceRequest} />
        <Route path="/universities" component={Universities} />
        <Route path="/universities/:slug" component={InstitutionDetail} />
        <Route path="/services" component={Services} />
        <Route path="/services/:kind" component={ServiceRequest} />
        <Route path="/sourcing" component={Sourcing} />
        <Route path="/work-permits" component={WorkPermits} />
        <Route path="/work-permits/contact" component={ServiceRequest} />
