...
import { ClipboardList, GraduationCap, Handshake, LayoutDashboard, LogOut, PanelLeft } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ClipboardList, label: "Demandes", path: "/admin" },
  { icon: GraduationCap, label: "Admissions", path: "/admin" },
  { icon: Handshake, label: "Partenariats", path: "/admin" },
];
