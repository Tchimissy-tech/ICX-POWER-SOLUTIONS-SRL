...
type SourceAuthority = "official" | "partner" | "icx";
...
const copy = {
  fr: { title: "Bonjour, je suis l’assistant ICX", online: "Réponses sourcées", intro: "Je réponds à partir des parcours ICX et des sources officielles ou partenaires référencées. Je cite les liens utiles et je n’invente pas les conditions qui doivent être vérifiées.", placeholder: "Écrivez votre question…", send: "Envoyer", close: "Fermer le chat", open: "Ouvrir le chat ICX", retry: "Réessayer", prompts: ["Étudier à l’étranger", "Permis de travail", "Mines et ressources", "Créer une affiliation"], fallback: "Je peux vous orienter à partir de sources vérifiées. Précisez le pays ou l’organisation concernée.", sources: "Sources vérifiées", official: "Source officielle", partner: "Référence partenaire", icx: "Parcours ICX", disclaimer: "Orientation générale sourcée — aucune promesse d’emploi, de permis, d’admission ou de partenariat." },
  en: { title: "Hello, I’m the ICX assistant", online: "Source-based answers", intro: "I answer from ICX journeys and listed official or partner sources. I show useful links and do not invent conditions that must be verified.", placeholder: "Write your question…", send: "Send", close: "Close chat", open: "Open ICX chat", retry: "Try again", prompts: ["Study abroad", "Work permits", "Mining and resources", "Create an affiliation"], fallback: "I can provide guidance from verified sources. Please specify the country or organisation concerned.", sources: "Verified sources", official: "Official source", partner: "Partner reference", icx: "ICX journey", disclaimer: "Source-based general guidance — no promise of employment, permit, admission or partnership." },
  ro: { title: "Bună, sunt asistentul ICX", online: "Răspunsuri cu surse", intro: "Răspund pe baza parcursurilor ICX și a surselor oficiale sau partenere listate. Arăt linkurile utile și nu inventez condiții care trebuie verificate.", placeholder: "Scrieți întrebarea…", send: "Trimite", close: "Închide chatul", open: "Deschide chatul ICX", retry: "Încearcă din nou", prompts: ["Studii în străinătate", "Permise de muncă", "Mine și resurse", "Afiliere"], fallback: "Pot oferi orientare din surse verificate. Precizați țara sau organizația vizată.", sources: "Surse verificate", official: "Sursă oficială", partner: "Referință partener", icx: "Parcurs ICX", disclaimer: "Orientare generală cu surse — fără promisiuni de angajare, permis, admitere sau parteneriat." },
  pt: { title: "Olá, sou o assistente ICX", online: "Respostas com fontes", intro: "Respondo a partir dos percursos ICX e das fontes oficiais ou de parceiros listadas. Mostro links úteis e não invento condições que precisam de verificação.", placeholder: "Escreva a sua pergunta…", send: "Enviar", close: "Fechar chat", open: "Abrir chat ICX", retry: "Tentar novamente", prompts: ["Estudar no exterior", "Permissões de trabalho", "Minas e recursos", "Afiliação"], fallback: "Posso orientar com base em fontes verificadas. Indique o país ou a organização em causa.", sources: "Fontes verificadas", official: "Fonte oficial", partner: "Referência de parceiro", icx: "Percurso ICX", disclaimer: "Orientação geral com fontes — sem promessa de emprego, autorização, admissão ou parceria." },
  ar: { title: "مرحباً، أنا مساعد ICX", online: "إجابات بمصادر", intro: "أجيب بالاستناد إلى مسارات ICX والمصادر الرسمية أو الشريكة المدرجة. أعرض الروابط المفيدة ولا أختلق شروطاً يجب التحقق منها.", placeholder: "اكتب سؤالك…", send: "إرسال", close: "إغلاق المحادثة", open: "فتح محادثة ICX", retry: "إعادة المحاولة", prompts: ["الدراسة في الخارج", "تصاريح العمل", "المناجم والموارد", "إنشاء انتساب"], fallback: "يمكنني تقديم توجيه من مصادر موثوقة. حدد البلد أو المؤسسة المعنية.", sources: "مصادر موثوقة", official: "مصدر رسمي", partner: "مرجع شريك", icx: "مسار ICX", disclaimer: "توجيه عام بمصادر — دون وعود بعمل أو تصريح أو قبول أو شراكة." },
} as const;
